    ...
    return (
        <main className="bg-[#AEE3EF] h-screen font-poppins font-normal">
            ...
            <MainContainer title={'Agregar Paquetes'} height={'600px'}>
                <form className="rounded-xl flex justify-center h-[82%] flex-col p-4" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4 absolute right-12 bottom-[110px] flex justify-center">
                        <button type="submit" className="w-72 py-1 bg-[#F4C455] rounded-full font-poppins">
                            Agregar
                        </button>
                    </div>
                </form>
