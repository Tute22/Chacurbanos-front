        ...
        <div className="bg-white rounded-lg p-4 w-80 mt-[-20px] h-[600px] flex flex-col shadow-md justify-center">
          ...
          >
            <input
              ...
              onBlur={(e) =>
                handleValidation.handleAddress(e.currentTarget.value)
              }
              required
            />
            <input
              ...
              onBlur={(e) => handleValidation.handleName(e.currentTarget.value)}
              required
            />
            <input
              ...
              onBlur={(e) =>
                handleValidation.handlePackage(parseInt(e.currentTarget.value))
              }
              required
            />
