      ...
      <section className="flex justify-center mt-9">
        <section className="bg-[#55BBD1] h-[150px] rounded-xl">
          ...
          <div className="bg-white rounded-xl shadow-xl p-5 w-80">
            ...
            <br />
            <div
              className={`flex flex-col items-center border border-solid border-black rounded-xl`}
            >
                ...
                <div className="flex my-2">
                  ...
                  {renderedDays.map((day) => (
                    <div
                      key={day.number}
                      className={`${
                        day.time === "before" ? classBeforeToday : ""
                      } ${day.time === "today" ? classToday : ""} ${
                        day.time === "after" ? classAfterToday : ""
                      }`}
                    >
                      <h3
                        className={`text-lg font-poppins font-normal ${
                          day.time === "after" ? "text-[#626262]" : ""
                        }`}
                      >
                        {day.day}
                      </h3>
            ...
            >
              ...
              <div className="flex  justify-between w-[250px] mb-5">
                <Progress
                  type="circle"
                  percent={percentage(membersEnabled(members), members.length)}
                  strokeColor="#55BBD1"
                  size={70}
