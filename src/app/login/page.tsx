            ...
            <div className="mt-2 bg-white rounded-xl shadow-xl p-5 w-80 h-[300px]">
              <form>
                <div className="mb-4 gap-5">
                  ...
                  <input type="email" className={`${poppins400.className} w-full px-4 py-2 border rounded-lg focus:outline-none`} placeholder="    Email@contraseña.com" />
                </div>
                <div className="mb-4">
                ...
                <CloseEyeIcon className=" text-gray-400 w-5 h-6 mr-2 ml-[253px] mt-2 absolute"/>
                  <input type="password" className={`${poppins400.className} w-full px-4 py-2 border rounded-lg focus:outline-none`} placeholder="    **********" />
                </div>
                <div className="mb-4">
