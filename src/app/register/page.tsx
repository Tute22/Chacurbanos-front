...
export default function Register() {
    ...
    return (
        <main className="bg-[#AEE3EF] h-screen">
            <Navbar />
            <MainContainer title={'Creá tu cuenta'}  height=''>
                <div className="flex justify-center mb-4">
                    <Camera className="w-24 h-auto text-[#F4C455]" />
                </div>
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        <input type="text" className="font-poppins font-normal w-full px-4 py-2 border rounded-lg focus:outline-none" placeholder="Nombre" value={name} onChange={(e) => setName(e.currentTarget.value)} onBlur={(e) => handleValidation.handleName(e.currentTarget.value)} required />
                    </div>
                    <div className="mb-4">
                        <input type="text" className="font-poppins font-normal w-full px-4 py-2 border rounded-lg focus:outline-none" placeholder="Apellido" value={lastName} onChange={(e) => setLastName(e.currentTarget.value)} onBlur={(e) => handleValidation.handleLastName(e.currentTarget.value)} required />
                    </div>
                    <div className="mb-4">
                        <input type="email" className="font-poppins font-normal w-full px-4 py-2 border rounded-lg focus:outline-none" placeholder="Email@contraseña.com" value={email} onChange={(e) => setEmail(e.currentTarget.value)} onBlur={(e) => handleValidation.handleEmail(e.currentTarget.value)} required />
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        <input type="password" className="font-poppins font-normal w-full px-4 py-2 border rounded-lg focus:outline-none" placeholder="Confirmar contraseña" value={confirmPassword} onChange={(e) => setConfirmPassword(e.currentTarget.value)} onBlur={(e) => handleValidation.handleConfirmPassword(e.currentTarget.value)} required />
                    </div>
                    <div className="mb-4">
